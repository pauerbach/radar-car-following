...
datasets = {
    "IDM": {
        "ttc": "./ttc_idm_callbak_new.npy",
        "headway": "./headway_idm_callbak_new.npy",
    },
    "Simulation": {
        "ttc": "./ttc_simulated-radar-new.npy",
        "headway": "./headway_simulated-radar-new.npy",
    },
    "CFAR": {
        "ttc": "./ttc_cfar_kalmann_real.npy",
        "headway": "./headway_cfar_kalmann_real.npy",
    },
    "End-to-End": {
        "ttc": "./ttc_end-to-end-new.npy",
        "headway": "./headway_end-to-end-new.npy",
    },
}
