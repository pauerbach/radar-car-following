...
axs[0].hist(ttc_cfar, bins=100, density=True, label="CFAR", alpha=0.7)
...
axs[1].hist(headway_cfar, bins=100, density=True, label="CFAR", alpha=0.7)
...
# plt.show()
plt.savefig(
    "ttc_headway_comparison_real_world_with_cfar.png", dpi=300, bbox_inches="tight"
)
