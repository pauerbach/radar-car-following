...
sns.kdeplot(ttc_direct, ax=axs[0], label="Direct Input", linewidth=4, bw_adjust=0.2)
...
sns.kdeplot(headway_direct, ax=axs[1], label="Direct Input", linewidth=4, bw_adjust=0.2)
